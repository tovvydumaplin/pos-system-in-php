                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="user_type" required class="form-select">
                                        ...
                                        <option value="super_admin" <?= $userData['data']['user_type'] == 'super_admin' ? 'selected' : ''; ?>>Super Admin</option>
                                        <?php endif; ?>
                                    ...
                                    <select name="branch_id" class="form-select">
                                        ...
                                        if($branches && mysqli_num_rows($branches) > 0){
                                            foreach($branches as $branch){
                                                $selected = (isset($userData['data']['branch_id']) && $userData['data']['branch_id'] == $branch['id']) ? 'selected' : '';
