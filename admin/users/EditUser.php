...
<div class="container-fluid px-4 mt-4">
    ...
    <div class="page-hero">
        <div>
            <h2><i class="fas fa-user-edit me-2" style="opacity:0.75;"></i>Edit User</h2>
    ...
    <form action="<?= $baseUrl ?>code.php" method="POST">
        ...
        if (!$userData || $userData['status'] != 200) {
            echo '<div class="alert alert-danger">' . ($userData['message'] ?? 'User not found.') . '</div>';
            include('../includes/footer.php');
            exit;
        }
        ...
        <div class="form-panel">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="name" required class="form-control" value="<?= htmlspecialchars($u['name']) ?>">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="user_type" required class="form-select">
                        ...
                        <option value="super_admin" <?= $u['user_type'] == 'super_admin' ? 'selected' : '' ?>>Super Admin</option>
                        <?php endif; ?>
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" required class="form-control" value="<?= htmlspecialchars($u['email']) ?>">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="phone" required class="form-control" value="<?= htmlspecialchars($u['phone']) ?>">
                </div>
                    ...
                    <select name="branch_id" class="form-select">
                        ...
                        if ($branches && mysqli_num_rows($branches) > 0) {
                            foreach ($branches as $branch) {
                                $selected = (isset($u['branch_id']) && $u['branch_id'] == $branch['id']) ? 'selected' : '';
                ...
                <div class="col-md-6">
                    ...
                    <div class="ban-toggle">
                        <input type="checkbox" name="is_ban" id="banToggle" <?= $u['is_ban'] == 1 ? 'checked' : '' ?>>
                        <div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" name="updateUser" class="btn-save">
