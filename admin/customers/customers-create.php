...
<div class="container-fluid px-4 mt-4">
    ...
    <div class="page-hero">
        <div>
            <h2><i class="fas fa-user-plus me-2" style="opacity:0.75;"></i>Add Customer</h2>
    ...
    <form action="../code.php" method="POST">
        <div class="form-panel">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="phone" class="form-control" placeholder="e.g. 09123456789">
                </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" name="saveCustomer" class="btn-save">
